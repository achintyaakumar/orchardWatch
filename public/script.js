...
var weatherMap = {
  0: { type: 'severe', class: '', intensity: 5, icon: 'wi-tornado', name: 'Tornado' }, //tornado
...
function setWeather(weather) {
  ...
  if(time>weather.sys.sunset || time<weather.sys.sunrise){ //check for night or day
    ...
    else if((weather.weather[0].id/100).toFixed(0)==7) { //foggy night
...
setInterval(showPosition, 60000);
